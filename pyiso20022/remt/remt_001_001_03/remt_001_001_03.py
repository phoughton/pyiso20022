...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:remt.001.001.03"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:remt.001.001.03",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class OriginalPaymentInformation7:
...
class RemittanceInformation13:
    ...
    orgnl_pmt_inf: Optional[OriginalPaymentInformation7] = field(
        default=None,
        metadata={
            "name": "OrgnlPmtInf",
            "type": "Element",
...
class RemittanceAdviceV03:
    ...
    rmt_inf: List[RemittanceInformation13] = field(
        default_factory=list,
        metadata={
            "name": "RmtInf",
            "type": "Element",
...
class Document:
    ...
    rmt_advc: Optional[RemittanceAdviceV03] = field(
        default=None,
        metadata={
            "name": "RmtAdvc",
            "type": "Element",
