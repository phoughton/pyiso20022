...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:remt.001.001.05"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:remt.001.001.05",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class OriginalPaymentInformation9:
...
class RemittanceInformation20:
    ...
    orgnl_pmt_inf: Optional[OriginalPaymentInformation9] = field(
        default=None,
        metadata={
            "name": "OrgnlPmtInf",
            "type": "Element",
...
class RemittanceAdviceV05:
    ...
    rmt_inf: List[RemittanceInformation20] = field(
        default_factory=list,
        metadata={
            "name": "RmtInf",
            "type": "Element",
...
class Document:
    ...
    rmt_advc: Optional[RemittanceAdviceV05] = field(
        default=None,
        metadata={
            "name": "RmtAdvc",
            "type": "Element",
