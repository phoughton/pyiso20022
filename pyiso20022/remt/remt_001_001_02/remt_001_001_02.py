...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:remt.001.001.02"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:remt.001.001.02",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
class RemittanceAdviceV02:
    ...
    rmt_inf: List[RemittanceInformation12] = field(
        default_factory=list,
        metadata={
            "name": "RmtInf",
            "type": "Element",
...
class Document:
    ...
    rmt_advc: Optional[RemittanceAdviceV02] = field(
        default=None,
        metadata={
            "name": "RmtAdvc",
            "type": "Element",
