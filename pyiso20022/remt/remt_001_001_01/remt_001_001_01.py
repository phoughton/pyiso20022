...
__NAMESPACE__ = "urn:iso:std:iso:20022:tech:xsd:remt.001.001.01"
...
class AccountSchemeName1Choice:
    cd: Optional[str] = field(
        ...
        metadata={
            "name": "Cd",
            "type": "Element",
            "namespace": "urn:iso:std:iso:20022:tech:xsd:remt.001.001.01",
            "min_length": 1,
            "max_length": 4,
        },
    )
...
@dataclass
class ReferredDocumentInformation4:
...
@dataclass
class OriginalPaymentInformation6:
    refs: Optional[TransactionReferences4] = field(
        default=None,
        metadata={
            "name": "Refs",
            "type": "Element",
...
@dataclass
class StructuredRemittanceInformation10:
    rfrd_doc_inf: List[ReferredDocumentInformation4] = field(
        default_factory=list,
        metadata={
            "name": "RfrdDocInf",
            "type": "Element",
...
class RemittanceInformation8:
    ...
    strd: List[StructuredRemittanceInformation10] = field(
        default_factory=list,
        metadata={
            "name": "Strd",
            "type": "Element",
    ...
    orgnl_pmt_inf: Optional[OriginalPaymentInformation6] = field(
        default=None,
        metadata={
            "name": "OrgnlPmtInf",
            "type": "Element",
...
@dataclass
class RemittanceAdviceV01:
    grp_hdr: Optional[GroupHeader62] = field(
        default=None,
        metadata={
            "name": "GrpHdr",
            "type": "Element",
    ...
    rmt_inf: List[RemittanceInformation8] = field(
        default_factory=list,
        metadata={
            "name": "RmtInf",
            "type": "Element",
...
class Document:
    ...
    rmt_advc: Optional[RemittanceAdviceV01] = field(
        default=None,
        metadata={
            "name": "RmtAdvc",
            "type": "Element",
