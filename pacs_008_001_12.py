...
#
# Generated Tue Mar 19 20:33:39 2024 by generateDS.py version 2.43.3.
# Python 3.11.4 (main, Jul  4 2023, 05:25:16) [GCC 12.2.0]
#
# Command line options:
#   ('-o', 'pacs_008_001_12.py')
#
# Command line arguments:
#   xsd/pacs.008.001.12.xsd
#
# Command line:
#   /home/vscode/.local/bin/generateDS -o "pacs_008_001_12.py" xsd/pacs.008.001.12.xsd
#
...
class MandateClassification1Code(str, Enum):
    FIXE='FIXE'
    USGB='USGB'
    VARI='VARI'
...
class PreferredContactMethod2Code(str, Enum):
    MAIL='MAIL'
    FAXX='FAXX'
    LETT='LETT'
    CELL='CELL'
...
class AccountIdentification4Choice(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='AccountIdentification4Choice', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='AccountIdentification4Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='AccountIdentification4Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class AccountSchemeName1Choice(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='AccountSchemeName1Choice', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='AccountSchemeName1Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='AccountSchemeName1Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class AddressType3Choice(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='AddressType3Choice', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='AddressType3Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='AddressType3Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class BranchAndFinancialInstitutionIdentification8(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, BranchAndFinancialInstitutionIdentification8)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if BranchAndFinancialInstitutionIdentification8.subclass:
            return BranchAndFinancialInstitutionIdentification8.subclass(*args_, **kwargs_)
        else:
            return BranchAndFinancialInstitutionIdentification8(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='BranchAndFinancialInstitutionIdentification8', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('BranchAndFinancialInstitutionIdentification8')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'BranchAndFinancialInstitutionIdentification8':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='BranchAndFinancialInstitutionIdentification8')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='BranchAndFinancialInstitutionIdentification8', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='BranchAndFinancialInstitutionIdentification8'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='BranchAndFinancialInstitutionIdentification8', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'FinInstnId':
            obj_ = FinancialInstitutionIdentification23.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.FinInstnId = obj_
            obj_.original_tagname_ = 'FinInstnId'
        elif nodeName_ == 'BrnchId':
            obj_ = BranchData5.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.BrnchId = obj_
            obj_.original_tagname_ = 'BrnchId'
# end class BranchAndFinancialInstitutionIdentification8


class BranchData5(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, BranchData5)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if BranchData5.subclass:
            return BranchData5.subclass(*args_, **kwargs_)
        else:
            return BranchData5(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='BranchData5', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('BranchData5')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'BranchData5':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='BranchData5')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='BranchData5', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='BranchData5'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='BranchData5', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Id':
            ...
            obj_ = PostalAddress27.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.PstlAdr = obj_
            obj_.original_tagname_ = 'PstlAdr'
# end class BranchData5


class CashAccount40(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, CashAccount40)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if CashAccount40.subclass:
            return CashAccount40.subclass(*args_, **kwargs_)
        else:
            return CashAccount40(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='CashAccount40', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('CashAccount40')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'CashAccount40':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='CashAccount40')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='CashAccount40', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CashAccount40'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='CashAccount40', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CashAccountType2Choice(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='CashAccountType2Choice', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CashAccountType2Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='CashAccountType2Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CategoryPurpose1Choice(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='CategoryPurpose1Choice', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CategoryPurpose1Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='CategoryPurpose1Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ChargeType3Choice(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Cd=None, Prtry=None, gds_collector_=None, **kwargs_):
        ...
        self.ns_prefix_ = None
        self.Cd = Cd
        self.validate_ExternalChargeType1Code(self.Cd)
        self.Cd_nsprefix_ = None
        self.Prtry = Prtry
        self.Prtry_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ChargeType3Choice)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ChargeType3Choice.subclass:
            return ChargeType3Choice.subclass(*args_, **kwargs_)
        else:
            return ChargeType3Choice(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def set_Prtry(self, Prtry):
        self.Prtry = Prtry
    def validate_ExternalChargeType1Code(self, value):
        result = True
        # Validate type ExternalChargeType1Code, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if len(value) > 4:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on ExternalChargeType1Code' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) < 1:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minLength restriction on ExternalChargeType1Code' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='ChargeType3Choice', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ChargeType3Choice')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'ChargeType3Choice':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ChargeType3Choice')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ChargeType3Choice', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ChargeType3Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='ChargeType3Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Cd':
            ...
            self.Cd = value_
            self.Cd_nsprefix_ = child_.prefix
            # validate type ExternalChargeType1Code
            self.validate_ExternalChargeType1Code(self.Cd)
        elif nodeName_ == 'Prtry':
            obj_ = GenericIdentification3.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Prtry = obj_
            obj_.original_tagname_ = 'Prtry'
# end class ChargeType3Choice


class Charges16(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Amt=None, Agt=None, Tp=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, Charges16)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if Charges16.subclass:
            return Charges16.subclass(*args_, **kwargs_)
        else:
            return Charges16(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            self.Agt is not None or
            self.Tp is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='Charges16', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('Charges16')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'Charges16':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Charges16')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='Charges16', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Charges16'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='Charges16', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Amt':
            ...
            obj_ = BranchAndFinancialInstitutionIdentification8.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Agt = obj_
            obj_.original_tagname_ = 'Agt'
        elif nodeName_ == 'Tp':
            obj_ = ChargeType3Choice.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Tp = obj_
            obj_.original_tagname_ = 'Tp'
# end class Charges16
...
class ClearingSystemIdentification2Choice(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='ClearingSystemIdentification2Choice', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ClearingSystemIdentification2Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='ClearingSystemIdentification2Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ClearingSystemIdentification3Choice(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='ClearingSystemIdentification3Choice', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ClearingSystemIdentification3Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='ClearingSystemIdentification3Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ClearingSystemMemberIdentification2(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='ClearingSystemMemberIdentification2', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ClearingSystemMemberIdentification2'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='ClearingSystemMemberIdentification2', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Contact13(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, NmPrfx=None, Nm=None, PhneNb=None, MobNb=None, FaxNb=None, URLAdr=None, EmailAdr=None, EmailPurp=None, JobTitl=None, Rspnsblty=None, Dept=None, Othr=None, PrefrdMtd=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.URLAdr = URLAdr
        self.validate_Max2048Text(self.URLAdr)
        self.URLAdr_nsprefix_ = None
        self.EmailAdr = EmailAdr
        self.validate_Max256Text(self.EmailAdr)
        ...
        self.validate_PreferredContactMethod2Code(self.PrefrdMtd)
        self.PrefrdMtd_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, Contact13)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if Contact13.subclass:
            return Contact13.subclass(*args_, **kwargs_)
        else:
            return Contact13(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def validate_Max2048Text(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) < 1:
                ...
                result = False
        return result
    def validate_Max256Text(self, value):
        result = True
        # Validate type Max256Text, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if len(value) > 256:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on Max256Text' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) < 1:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minLength restriction on Max256Text' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_Max35Text(self, value):
        result = True
    ...
    def validate_Max70Text(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) < 1:
                ...
                result = False
        return result
    def validate_PreferredContactMethod2Code(self, value):
        result = True
        # Validate type PreferredContactMethod2Code, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
                return False
            value = value
            enumerations = ['MAIL', 'FAXX', 'LETT', 'CELL', 'ONLI', 'PHON']
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on PreferredContactMethod2Code' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='Contact13', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('Contact13')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'Contact13':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Contact13')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='Contact13', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Contact13'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='Contact13', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.URLAdr is not None:
            namespaceprefix_ = self.URLAdr_nsprefix_ + ':' if (UseCapturedNS_ and self.URLAdr_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sURLAdr>%s</%sURLAdr>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.URLAdr), input_name='URLAdr')), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'NmPrfx':
            ...
            # validate type PhoneNumber
            self.validate_PhoneNumber(self.FaxNb)
        elif nodeName_ == 'URLAdr':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'URLAdr')
            value_ = self.gds_validate_string(value_, node, 'URLAdr')
            self.URLAdr = value_
            self.URLAdr_nsprefix_ = child_.prefix
            ...
            # validate type PreferredContactMethod2Code
            self.validate_PreferredContactMethod2Code(self.PrefrdMtd)
# end class Contact13


class CreditTransferMandateData1(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, MndtId=None, Tp=None, DtOfSgntr=None, DtOfVrfctn=None, ElctrncSgntr=None, FrstPmtDt=None, FnlPmtDt=None, Frqcy=None, Rsn=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        self.MndtId = MndtId
        self.validate_Max35Text(self.MndtId)
        self.MndtId_nsprefix_ = None
        self.Tp = Tp
        self.Tp_nsprefix_ = None
        if isinstance(DtOfSgntr, BaseStrType_):
            initvalue_ = datetime_.datetime.strptime(DtOfSgntr, '%Y-%m-%d').date()
        else:
            initvalue_ = DtOfSgntr
        self.DtOfSgntr = initvalue_
        self.DtOfSgntr_nsprefix_ = None
        if isinstance(DtOfVrfctn, BaseStrType_):
            initvalue_ = datetime_.datetime.strptime(DtOfVrfctn, '%Y-%m-%dT%H:%M:%S')
        else:
            initvalue_ = DtOfVrfctn
        self.DtOfVrfctn = initvalue_
        self.DtOfVrfctn_nsprefix_ = None
        self.ElctrncSgntr = ElctrncSgntr
        self.validate_Max10KBinary(self.ElctrncSgntr)
        self.ElctrncSgntr_nsprefix_ = None
        if isinstance(FrstPmtDt, BaseStrType_):
            initvalue_ = datetime_.datetime.strptime(FrstPmtDt, '%Y-%m-%d').date()
        else:
            initvalue_ = FrstPmtDt
        self.FrstPmtDt = initvalue_
        self.FrstPmtDt_nsprefix_ = None
        if isinstance(FnlPmtDt, BaseStrType_):
            initvalue_ = datetime_.datetime.strptime(FnlPmtDt, '%Y-%m-%d').date()
        else:
            initvalue_ = FnlPmtDt
        self.FnlPmtDt = initvalue_
        self.FnlPmtDt_nsprefix_ = None
        self.Frqcy = Frqcy
        self.Frqcy_nsprefix_ = None
        self.Rsn = Rsn
        self.Rsn_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, CreditTransferMandateData1)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if CreditTransferMandateData1.subclass:
            return CreditTransferMandateData1.subclass(*args_, **kwargs_)
        else:
            return CreditTransferMandateData1(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def get_MndtId(self):
        return self.MndtId
    def set_MndtId(self, MndtId):
        self.MndtId = MndtId
    def get_Tp(self):
        return self.Tp
    def set_Tp(self, Tp):
        self.Tp = Tp
    def get_DtOfSgntr(self):
        return self.DtOfSgntr
    def set_DtOfSgntr(self, DtOfSgntr):
        self.DtOfSgntr = DtOfSgntr
    def get_DtOfVrfctn(self):
        return self.DtOfVrfctn
    def set_DtOfVrfctn(self, DtOfVrfctn):
        self.DtOfVrfctn = DtOfVrfctn
    def get_ElctrncSgntr(self):
        return self.ElctrncSgntr
    def set_ElctrncSgntr(self, ElctrncSgntr):
        self.ElctrncSgntr = ElctrncSgntr
    def get_FrstPmtDt(self):
        return self.FrstPmtDt
    def set_FrstPmtDt(self, FrstPmtDt):
        self.FrstPmtDt = FrstPmtDt
    def get_FnlPmtDt(self):
        return self.FnlPmtDt
    def set_FnlPmtDt(self, FnlPmtDt):
        self.FnlPmtDt = FnlPmtDt
    def get_Frqcy(self):
        return self.Frqcy
    def set_Frqcy(self, Frqcy):
        self.Frqcy = Frqcy
    def get_Rsn(self):
        return self.Rsn
    ...
    def validate_ISODateTime(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            pass
        return result
    def validate_Max10KBinary(self, value):
        result = True
        # Validate type Max10KBinary, a restriction on xs:base64Binary.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if len(value) > 10240:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on Max10KBinary' % {"value": value, "lineno": lineno} )
                result = False
            if len(value) < 1:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minLength restriction on Max10KBinary' % {"value" : value, "lineno": lineno} )
                result = False
        return result
    def has__content(self):
        if (
            self.MndtId is not None or
            self.Tp is not None or
            self.DtOfSgntr is not None or
            self.DtOfVrfctn is not None or
            self.ElctrncSgntr is not None or
            self.FrstPmtDt is not None or
            self.FnlPmtDt is not None or
            self.Frqcy is not None or
            self.Rsn is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='CreditTransferMandateData1', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('CreditTransferMandateData1')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'CreditTransferMandateData1':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='CreditTransferMandateData1')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='CreditTransferMandateData1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CreditTransferMandateData1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='CreditTransferMandateData1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.MndtId is not None:
            namespaceprefix_ = self.MndtId_nsprefix_ + ':' if (UseCapturedNS_ and self.MndtId_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sMndtId>%s</%sMndtId>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.MndtId), input_name='MndtId')), namespaceprefix_ , eol_))
        if self.Tp is not None:
            namespaceprefix_ = self.Tp_nsprefix_ + ':' if (UseCapturedNS_ and self.Tp_nsprefix_) else ''
            self.Tp.export(outfile, level, namespaceprefix_, namespacedef_='', name_='Tp', pretty_print=pretty_print)
        if self.DtOfSgntr is not None:
            namespaceprefix_ = self.DtOfSgntr_nsprefix_ + ':' if (UseCapturedNS_ and self.DtOfSgntr_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDtOfSgntr>%s</%sDtOfSgntr>%s' % (namespaceprefix_ , self.gds_format_date(self.DtOfSgntr, input_name='DtOfSgntr'), namespaceprefix_ , eol_))
        if self.DtOfVrfctn is not None:
            namespaceprefix_ = self.DtOfVrfctn_nsprefix_ + ':' if (UseCapturedNS_ and self.DtOfVrfctn_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sDtOfVrfctn>%s</%sDtOfVrfctn>%s' % (namespaceprefix_ , self.gds_format_datetime(self.DtOfVrfctn, input_name='DtOfVrfctn'), namespaceprefix_ , eol_))
        if self.ElctrncSgntr is not None:
            namespaceprefix_ = self.ElctrncSgntr_nsprefix_ + ':' if (UseCapturedNS_ and self.ElctrncSgntr_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sElctrncSgntr>%s</%sElctrncSgntr>%s' % (namespaceprefix_ , self.gds_format_base64(self.ElctrncSgntr, input_name='ElctrncSgntr'), namespaceprefix_ , eol_))
        if self.FrstPmtDt is not None:
            namespaceprefix_ = self.FrstPmtDt_nsprefix_ + ':' if (UseCapturedNS_ and self.FrstPmtDt_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sFrstPmtDt>%s</%sFrstPmtDt>%s' % (namespaceprefix_ , self.gds_format_date(self.FrstPmtDt, input_name='FrstPmtDt'), namespaceprefix_ , eol_))
        if self.FnlPmtDt is not None:
            namespaceprefix_ = self.FnlPmtDt_nsprefix_ + ':' if (UseCapturedNS_ and self.FnlPmtDt_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sFnlPmtDt>%s</%sFnlPmtDt>%s' % (namespaceprefix_ , self.gds_format_date(self.FnlPmtDt, input_name='FnlPmtDt'), namespaceprefix_ , eol_))
        if self.Frqcy is not None:
            namespaceprefix_ = self.Frqcy_nsprefix_ + ':' if (UseCapturedNS_ and self.Frqcy_nsprefix_) else ''
            self.Frqcy.export(outfile, level, namespaceprefix_, namespacedef_='', name_='Frqcy', pretty_print=pretty_print)
        if self.Rsn is not None:
            namespaceprefix_ = self.Rsn_nsprefix_ + ':' if (UseCapturedNS_ and self.Rsn_nsprefix_) else ''
            self.Rsn.export(outfile, level, namespaceprefix_, namespacedef_='', name_='Rsn', pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'MndtId':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'MndtId')
            value_ = self.gds_validate_string(value_, node, 'MndtId')
            self.MndtId = value_
            self.MndtId_nsprefix_ = child_.prefix
            # validate type Max35Text
            self.validate_Max35Text(self.MndtId)
        elif nodeName_ == 'Tp':
            obj_ = MandateTypeInformation2.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Tp = obj_
            obj_.original_tagname_ = 'Tp'
        elif nodeName_ == 'DtOfSgntr':
            sval_ = child_.text
            dval_ = self.gds_parse_date(sval_)
            self.DtOfSgntr = dval_
            self.DtOfSgntr_nsprefix_ = child_.prefix
            # validate type ISODate
            self.validate_ISODate(self.DtOfSgntr)
        elif nodeName_ == 'DtOfVrfctn':
            sval_ = child_.text
            dval_ = self.gds_parse_datetime(sval_)
            self.DtOfVrfctn = dval_
            self.DtOfVrfctn_nsprefix_ = child_.prefix
            # validate type ISODateTime
            self.validate_ISODateTime(self.DtOfVrfctn)
        elif nodeName_ == 'ElctrncSgntr':
            sval_ = child_.text
            if sval_ is not None:
                ...
                bval_ = self.gds_validate_base64(bval_, node, 'ElctrncSgntr')
            else:
                bval_ = None
            self.ElctrncSgntr = bval_
            self.ElctrncSgntr_nsprefix_ = child_.prefix
            # validate type Max10KBinary
            self.validate_Max10KBinary(self.ElctrncSgntr)
        elif nodeName_ == 'FrstPmtDt':
            sval_ = child_.text
            dval_ = self.gds_parse_date(sval_)
            self.FrstPmtDt = dval_
            self.FrstPmtDt_nsprefix_ = child_.prefix
            # validate type ISODate
            self.validate_ISODate(self.FrstPmtDt)
        elif nodeName_ == 'FnlPmtDt':
            sval_ = child_.text
            dval_ = self.gds_parse_date(sval_)
            self.FnlPmtDt = dval_
            self.FnlPmtDt_nsprefix_ = child_.prefix
            # validate type ISODate
            self.validate_ISODate(self.FnlPmtDt)
        elif nodeName_ == 'Frqcy':
            obj_ = Frequency36Choice.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Frqcy = obj_
            obj_.original_tagname_ = 'Frqcy'
        elif nodeName_ == 'Rsn':
            obj_ = MandateSetupReason1Choice.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Rsn = obj_
            obj_.original_tagname_ = 'Rsn'
# end class CreditTransferMandateData1


class CreditTransferTransaction64(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, PmtId=None, PmtTpInf=None, IntrBkSttlmAmt=None, IntrBkSttlmDt=None, SttlmPrty=None, SttlmTmIndctn=None, SttlmTmReq=None, AccptncDtTm=None, PoolgAdjstmntDt=None, InstdAmt=None, XchgRate=None, ChrgBr=None, ChrgsInf=None, MndtRltdInf=None, PrvsInstgAgt1=None, PrvsInstgAgt1Acct=None, PrvsInstgAgt2=None, PrvsInstgAgt2Acct=None, PrvsInstgAgt3=None, PrvsInstgAgt3Acct=None, InstgAgt=None, InstdAgt=None, IntrmyAgt1=None, IntrmyAgt1Acct=None, IntrmyAgt2=None, IntrmyAgt2Acct=None, IntrmyAgt3=None, IntrmyAgt3Acct=None, UltmtDbtr=None, InitgPty=None, Dbtr=None, DbtrAcct=None, DbtrAgt=None, DbtrAgtAcct=None, CdtrAgt=None, CdtrAgtAcct=None, Cdtr=None, CdtrAcct=None, UltmtCdtr=None, InstrForCdtrAgt=None, InstrForNxtAgt=None, Purp=None, RgltryRptg=None, Tax=None, RltdRmtInf=None, RmtInf=None, SplmtryData=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.MndtRltdInf = MndtRltdInf
        self.MndtRltdInf_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, CreditTransferTransaction64)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if CreditTransferTransaction64.subclass:
            return CreditTransferTransaction64.subclass(*args_, **kwargs_)
        else:
            return CreditTransferTransaction64(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def get_MndtRltdInf(self):
        return self.MndtRltdInf
    def set_MndtRltdInf(self, MndtRltdInf):
        self.MndtRltdInf = MndtRltdInf
    ...
    def has__content(self):
        if (
            ...
            self.ChrgsInf or
            self.MndtRltdInf is not None or
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='CreditTransferTransaction64', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('CreditTransferTransaction64')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'CreditTransferTransaction64':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='CreditTransferTransaction64')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='CreditTransferTransaction64', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CreditTransferTransaction64'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='CreditTransferTransaction64', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.MndtRltdInf is not None:
            namespaceprefix_ = self.MndtRltdInf_nsprefix_ + ':' if (UseCapturedNS_ and self.MndtRltdInf_nsprefix_) else ''
            self.MndtRltdInf.export(outfile, level, namespaceprefix_, namespacedef_='', name_='MndtRltdInf', pretty_print=pretty_print)
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'PmtId':
            obj_ = PaymentIdentification13.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.PmtId = obj_
            ...
            obj_ = Charges16.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.ChrgsInf.append(obj_)
            obj_.original_tagname_ = 'ChrgsInf'
        elif nodeName_ == 'MndtRltdInf':
            obj_ = CreditTransferMandateData1.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.MndtRltdInf = obj_
            obj_.original_tagname_ = 'MndtRltdInf'
            ...
            obj_ = CashAccount40.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            ...
            obj_ = PartyIdentification272.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.UltmtDbtr = obj_
            ...
            obj_ = InstructionForCreditorAgent3.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            ...
            obj_ = TaxData1.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Tax = obj_
            obj_.original_tagname_ = 'Tax'
        elif nodeName_ == 'RltdRmtInf':
            obj_ = RemittanceLocation8.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.RltdRmtInf.append(obj_)
            obj_.original_tagname_ = 'RltdRmtInf'
        elif nodeName_ == 'RmtInf':
            obj_ = RemittanceInformation22.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.RmtInf = obj_
...
# end class CreditTransferTransaction64


class CreditorReferenceInformation3(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, CreditorReferenceInformation3)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if CreditorReferenceInformation3.subclass:
            return CreditorReferenceInformation3.subclass(*args_, **kwargs_)
        else:
            return CreditorReferenceInformation3(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='CreditorReferenceInformation3', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('CreditorReferenceInformation3')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'CreditorReferenceInformation3':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='CreditorReferenceInformation3')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='CreditorReferenceInformation3', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CreditorReferenceInformation3'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='CreditorReferenceInformation3', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Tp':
            obj_ = CreditorReferenceType3.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Tp = obj_
            obj_.original_tagname_ = 'Tp'
        elif nodeName_ == 'Ref':
            ...
            # validate type Max35Text
            self.validate_Max35Text(self.Ref)
# end class CreditorReferenceInformation3


class CreditorReferenceType2Choice(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Cd=None, Prtry=None, gds_collector_=None, **kwargs_):
        ...
        self.ns_prefix_ = None
        self.Cd = Cd
        self.validate_ExternalCreditorReferenceType1Code(self.Cd)
        self.Cd_nsprefix_ = None
        self.Prtry = Prtry
        self.validate_Max35Text(self.Prtry)
        self.Prtry_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, CreditorReferenceType2Choice)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if CreditorReferenceType2Choice.subclass:
            return CreditorReferenceType2Choice.subclass(*args_, **kwargs_)
        else:
            return CreditorReferenceType2Choice(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def set_Prtry(self, Prtry):
        self.Prtry = Prtry
    def validate_ExternalCreditorReferenceType1Code(self, value):
        result = True
        # Validate type ExternalCreditorReferenceType1Code, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if len(value) > 4:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on ExternalCreditorReferenceType1Code' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) < 1:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minLength restriction on ExternalCreditorReferenceType1Code' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_Max35Text(self, value):
        result = True
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='CreditorReferenceType2Choice', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('CreditorReferenceType2Choice')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'CreditorReferenceType2Choice':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='CreditorReferenceType2Choice')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='CreditorReferenceType2Choice', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CreditorReferenceType2Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='CreditorReferenceType2Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Cd':
            ...
            self.Cd = value_
            self.Cd_nsprefix_ = child_.prefix
            # validate type ExternalCreditorReferenceType1Code
            self.validate_ExternalCreditorReferenceType1Code(self.Cd)
        elif nodeName_ == 'Prtry':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'Prtry')
            ...
            # validate type Max35Text
            self.validate_Max35Text(self.Prtry)
# end class CreditorReferenceType2Choice


class CreditorReferenceType3(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, CreditorReferenceType3)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if CreditorReferenceType3.subclass:
            return CreditorReferenceType3.subclass(*args_, **kwargs_)
        else:
            return CreditorReferenceType3(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='CreditorReferenceType3', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('CreditorReferenceType3')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'CreditorReferenceType3':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='CreditorReferenceType3')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='CreditorReferenceType3', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='CreditorReferenceType3'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='CreditorReferenceType3', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'CdOrPrtry':
            obj_ = CreditorReferenceType2Choice.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.CdOrPrtry = obj_
            ...
            # validate type Max35Text
            self.validate_Max35Text(self.Issr)
# end class CreditorReferenceType3
...
class DateAndPlaceOfBirth1(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DateAndPlaceOfBirth1', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='DateAndPlaceOfBirth1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DateAndPlaceOfBirth1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class DateAndType1(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Tp=None, Dt=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, DateAndType1)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if DateAndType1.subclass:
            return DateAndType1.subclass(*args_, **kwargs_)
        else:
            return DateAndType1(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DateAndType1', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('DateAndType1')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'DateAndType1':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='DateAndType1')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='DateAndType1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='DateAndType1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DateAndType1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Tp':
            obj_ = DateType2Choice.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Tp = obj_
            obj_.original_tagname_ = 'Tp'
        elif nodeName_ == 'Dt':
...
class DatePeriod2(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DatePeriod2', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='DatePeriod2'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DatePeriod2', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class DateType2Choice(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Cd=None, Prtry=None, gds_collector_=None, **kwargs_):
        ...
        self.ns_prefix_ = None
        self.Cd = Cd
        self.validate_ExternalDateType1Code(self.Cd)
        self.Cd_nsprefix_ = None
        self.Prtry = Prtry
        self.validate_Max35Text(self.Prtry)
        self.Prtry_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, DateType2Choice)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if DateType2Choice.subclass:
            return DateType2Choice.subclass(*args_, **kwargs_)
        else:
            return DateType2Choice(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def set_Prtry(self, Prtry):
        self.Prtry = Prtry
    def validate_ExternalDateType1Code(self, value):
        result = True
        # Validate type ExternalDateType1Code, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if len(value) > 4:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on ExternalDateType1Code' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) < 1:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minLength restriction on ExternalDateType1Code' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_Max35Text(self, value):
        result = True
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DateType2Choice', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('DateType2Choice')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'DateType2Choice':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='DateType2Choice')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='DateType2Choice', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='DateType2Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DateType2Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Cd':
            ...
            self.Cd = value_
            self.Cd_nsprefix_ = child_.prefix
            # validate type ExternalDateType1Code
            self.validate_ExternalDateType1Code(self.Cd)
        elif nodeName_ == 'Prtry':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'Prtry')
...
class Document(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='Document', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Document'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='Document', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'FIToFICstmrCdtTrf':
            obj_ = FIToFICustomerCreditTransferV12.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
...
class DocumentAdjustment1(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DocumentAdjustment1', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='DocumentAdjustment1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DocumentAdjustment1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class DocumentAmount1(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, DocumentAmount1)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if DocumentAmount1.subclass:
            return DocumentAmount1.subclass(*args_, **kwargs_)
        else:
            return DocumentAmount1(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DocumentAmount1', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('DocumentAmount1')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'DocumentAmount1':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='DocumentAmount1')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='DocumentAmount1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='DocumentAmount1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DocumentAmount1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Tp':
            obj_ = DocumentAmountType1Choice.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Tp = obj_
            obj_.original_tagname_ = 'Tp'
        elif nodeName_ == 'Amt':
            ...
            self.Amt = obj_
            obj_.original_tagname_ = 'Amt'
# end class DocumentAmount1


class DocumentAmountType1Choice(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Cd=None, Prtry=None, gds_collector_=None, **kwargs_):
        ...
        self.ns_prefix_ = None
        self.Cd = Cd
        self.validate_ExternalDocumentAmountType1Code(self.Cd)
        self.Cd_nsprefix_ = None
        self.Prtry = Prtry
        self.validate_Max35Text(self.Prtry)
        self.Prtry_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, DocumentAmountType1Choice)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if DocumentAmountType1Choice.subclass:
            return DocumentAmountType1Choice.subclass(*args_, **kwargs_)
        else:
            return DocumentAmountType1Choice(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def set_Prtry(self, Prtry):
        self.Prtry = Prtry
    def validate_ExternalDocumentAmountType1Code(self, value):
        result = True
        # Validate type ExternalDocumentAmountType1Code, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if len(value) > 4:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on ExternalDocumentAmountType1Code' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) < 1:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minLength restriction on ExternalDocumentAmountType1Code' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_Max35Text(self, value):
        result = True
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DocumentAmountType1Choice', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('DocumentAmountType1Choice')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'DocumentAmountType1Choice':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='DocumentAmountType1Choice')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='DocumentAmountType1Choice', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='DocumentAmountType1Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DocumentAmountType1Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Cd':
            ...
            self.Cd = value_
            self.Cd_nsprefix_ = child_.prefix
            # validate type ExternalDocumentAmountType1Code
            self.validate_ExternalDocumentAmountType1Code(self.Cd)
        elif nodeName_ == 'Prtry':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'Prtry')
            ...
            # validate type Max35Text
            self.validate_Max35Text(self.Prtry)
# end class DocumentAmountType1Choice
...
class DocumentLineIdentification1(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DocumentLineIdentification1', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='DocumentLineIdentification1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DocumentLineIdentification1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class DocumentLineInformation2(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, DocumentLineInformation2)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if DocumentLineInformation2.subclass:
            return DocumentLineInformation2.subclass(*args_, **kwargs_)
        else:
            return DocumentLineInformation2(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DocumentLineInformation2', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('DocumentLineInformation2')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'DocumentLineInformation2':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='DocumentLineInformation2')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='DocumentLineInformation2', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='DocumentLineInformation2'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DocumentLineInformation2', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Id':
            ...
            obj_ = RemittanceAmount4.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Amt = obj_
            obj_.original_tagname_ = 'Amt'
# end class DocumentLineInformation2
...
class DocumentLineType1(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DocumentLineType1', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='DocumentLineType1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DocumentLineType1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class DocumentLineType1Choice(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DocumentLineType1Choice', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='DocumentLineType1Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DocumentLineType1Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class DocumentType1(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, CdOrPrtry=None, Issr=None, gds_collector_=None, **kwargs_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, DocumentType1)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if DocumentType1.subclass:
            return DocumentType1.subclass(*args_, **kwargs_)
        else:
            return DocumentType1(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DocumentType1', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('DocumentType1')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'DocumentType1':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='DocumentType1')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='DocumentType1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='DocumentType1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DocumentType1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'CdOrPrtry':
            obj_ = DocumentType2Choice.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.CdOrPrtry = obj_
            obj_.original_tagname_ = 'CdOrPrtry'
        elif nodeName_ == 'Issr':
            ...
            # validate type Max35Text
            self.validate_Max35Text(self.Issr)
# end class DocumentType1


class DocumentType2Choice(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Cd=None, Prtry=None, gds_collector_=None, **kwargs_):
        ...
        self.ns_prefix_ = None
        self.Cd = Cd
        self.validate_ExternalDocumentType1Code(self.Cd)
        self.Cd_nsprefix_ = None
        self.Prtry = Prtry
        self.validate_Max35Text(self.Prtry)
        self.Prtry_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, DocumentType2Choice)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if DocumentType2Choice.subclass:
            return DocumentType2Choice.subclass(*args_, **kwargs_)
        else:
            return DocumentType2Choice(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def set_Prtry(self, Prtry):
        self.Prtry = Prtry
    def validate_ExternalDocumentType1Code(self, value):
        result = True
        # Validate type ExternalDocumentType1Code, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if len(value) > 4:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on ExternalDocumentType1Code' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) < 1:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minLength restriction on ExternalDocumentType1Code' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_Max35Text(self, value):
        result = True
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DocumentType2Choice', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('DocumentType2Choice')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'DocumentType2Choice':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='DocumentType2Choice')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='DocumentType2Choice', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='DocumentType2Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='DocumentType2Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Cd':
            ...
            self.Cd = value_
            self.Cd_nsprefix_ = child_.prefix
            # validate type ExternalDocumentType1Code
            self.validate_ExternalDocumentType1Code(self.Cd)
        elif nodeName_ == 'Prtry':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'Prtry')
            ...
            # validate type Max35Text
            self.validate_Max35Text(self.Prtry)
# end class DocumentType2Choice


class FIToFICustomerCreditTransferV12(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, FIToFICustomerCreditTransferV12)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if FIToFICustomerCreditTransferV12.subclass:
            return FIToFICustomerCreditTransferV12.subclass(*args_, **kwargs_)
        else:
            return FIToFICustomerCreditTransferV12(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='FIToFICustomerCreditTransferV12', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('FIToFICustomerCreditTransferV12')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'FIToFICustomerCreditTransferV12':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='FIToFICustomerCreditTransferV12')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='FIToFICustomerCreditTransferV12', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='FIToFICustomerCreditTransferV12'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='FIToFICustomerCreditTransferV12', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'GrpHdr':
            obj_ = GroupHeader113.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.GrpHdr = obj_
            obj_.original_tagname_ = 'GrpHdr'
        elif nodeName_ == 'CdtTrfTxInf':
            obj_ = CreditTransferTransaction64.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            ...
            self.SplmtryData.append(obj_)
            obj_.original_tagname_ = 'SplmtryData'
# end class FIToFICustomerCreditTransferV12
...
class FinancialIdentificationSchemeName1Choice(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='FinancialIdentificationSchemeName1Choice', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='FinancialIdentificationSchemeName1Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='FinancialIdentificationSchemeName1Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class FinancialInstitutionIdentification23(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, FinancialInstitutionIdentification23)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if FinancialInstitutionIdentification23.subclass:
            return FinancialInstitutionIdentification23.subclass(*args_, **kwargs_)
        else:
            return FinancialInstitutionIdentification23(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='FinancialInstitutionIdentification23', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('FinancialInstitutionIdentification23')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'FinancialInstitutionIdentification23':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='FinancialInstitutionIdentification23')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='FinancialInstitutionIdentification23', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='FinancialInstitutionIdentification23'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='FinancialInstitutionIdentification23', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'BICFI':
            ...
            self.Othr = obj_
            obj_.original_tagname_ = 'Othr'
# end class FinancialInstitutionIdentification23


class Frequency36Choice(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Tp=None, Prd=None, PtInTm=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        self.Tp = Tp
        self.validate_Frequency6Code(self.Tp)
        self.Tp_nsprefix_ = None
        self.Prd = Prd
        self.Prd_nsprefix_ = None
        self.PtInTm = PtInTm
        self.PtInTm_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, Frequency36Choice)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if Frequency36Choice.subclass:
            return Frequency36Choice.subclass(*args_, **kwargs_)
        else:
            return Frequency36Choice(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def get_PtInTm(self):
        return self.PtInTm
    def set_PtInTm(self, PtInTm):
        self.PtInTm = PtInTm
    def validate_Frequency6Code(self, value):
        result = True
        # Validate type Frequency6Code, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
                return False
            value = value
            enumerations = ['YEAR', 'MNTH', 'QURT', 'MIAN', 'WEEK', 'DAIL', 'ADHO', 'INDA', 'FRTN']
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on Frequency6Code' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def has__content(self):
        if (
            ...
            self.PtInTm is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='Frequency36Choice', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('Frequency36Choice')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'Frequency36Choice':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Frequency36Choice')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='Frequency36Choice', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Frequency36Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='Frequency36Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.PtInTm is not None:
            namespaceprefix_ = self.PtInTm_nsprefix_ + ':' if (UseCapturedNS_ and self.PtInTm_nsprefix_) else ''
            self.PtInTm.export(outfile, level, namespaceprefix_, namespacedef_='', name_='PtInTm', pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Tp':
            ...
            # validate type Frequency6Code
            self.validate_Frequency6Code(self.Tp)
        elif nodeName_ == 'Prd':
            obj_ = FrequencyPeriod1.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Prd = obj_
            obj_.original_tagname_ = 'Prd'
        elif nodeName_ == 'PtInTm':
            obj_ = FrequencyAndMoment1.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.PtInTm = obj_
            obj_.original_tagname_ = 'PtInTm'
# end class Frequency36Choice


class FrequencyAndMoment1(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Tp=None, PtInTm=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.Tp_nsprefix_ = None
        self.PtInTm = PtInTm
        self.validate_Exact2NumericText(self.PtInTm)
        self.PtInTm_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, FrequencyAndMoment1)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if FrequencyAndMoment1.subclass:
            return FrequencyAndMoment1.subclass(*args_, **kwargs_)
        else:
            return FrequencyAndMoment1(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def validate_Frequency6Code(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value not in enumerations:
                ...
                result = False
        return result
    def validate_Exact2NumericText(self, value):
        result = True
        # Validate type Exact2NumericText, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
                return False
            if not self.gds_validate_simple_patterns(
                    self.validate_Exact2NumericText_patterns_, value):
                self.gds_collector_.add_message('Value "%s" does not match xsd pattern restrictions: %s' % (encode_str_2_3(value), self.validate_Exact2NumericText_patterns_, ))
                result = False
        return result
    validate_Exact2NumericText_patterns_ = [['^([0-9]{2})$']]
    def has__content(self):
        if (
            self.Tp is not None or
            self.PtInTm is not None
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='FrequencyAndMoment1', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('FrequencyAndMoment1')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'FrequencyAndMoment1':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='FrequencyAndMoment1')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='FrequencyAndMoment1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='FrequencyAndMoment1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='FrequencyAndMoment1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.PtInTm is not None:
            namespaceprefix_ = self.PtInTm_nsprefix_ + ':' if (UseCapturedNS_ and self.PtInTm_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sPtInTm>%s</%sPtInTm>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.PtInTm), input_name='PtInTm')), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Tp':
            ...
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'PtInTm')
            value_ = self.gds_validate_string(value_, node, 'PtInTm')
            self.PtInTm = value_
            self.PtInTm_nsprefix_ = child_.prefix
            # validate type Exact2NumericText
            self.validate_Exact2NumericText(self.PtInTm)
# end class FrequencyAndMoment1


class FrequencyPeriod1(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Tp=None, CntPerPrd=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.validate_Frequency6Code(self.Tp)
        self.Tp_nsprefix_ = None
        self.CntPerPrd = CntPerPrd
        self.validate_DecimalNumber(self.CntPerPrd)
        self.CntPerPrd_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, FrequencyPeriod1)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if FrequencyPeriod1.subclass:
            return FrequencyPeriod1.subclass(*args_, **kwargs_)
        else:
            return FrequencyPeriod1(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def set_Tp(self, Tp):
        self.Tp = Tp
    def get_CntPerPrd(self):
        return self.CntPerPrd
    def set_CntPerPrd(self, CntPerPrd):
        self.CntPerPrd = CntPerPrd
    def validate_Frequency6Code(self, value):
        result = True
        # Validate type Frequency6Code, a restriction on xs:string.
    ...
    def has__content(self):
        if (
            self.Tp is not None or
            self.CntPerPrd is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='FrequencyPeriod1', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('FrequencyPeriod1')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'FrequencyPeriod1':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='FrequencyPeriod1')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='FrequencyPeriod1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='FrequencyPeriod1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='FrequencyPeriod1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Tp is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sTp>%s</%sTp>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.Tp), input_name='Tp')), namespaceprefix_ , eol_))
        if self.CntPerPrd is not None:
            namespaceprefix_ = self.CntPerPrd_nsprefix_ + ':' if (UseCapturedNS_ and self.CntPerPrd_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCntPerPrd>%s</%sCntPerPrd>%s' % (namespaceprefix_ , self.gds_format_decimal(self.CntPerPrd, input_name='CntPerPrd'), namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Tp':
            ...
            # validate type Frequency6Code
            self.validate_Frequency6Code(self.Tp)
        elif nodeName_ == 'CntPerPrd' and child_.text:
            sval_ = child_.text
            fval_ = self.gds_parse_decimal(sval_, node, 'CntPerPrd')
            fval_ = self.gds_validate_decimal(fval_, node, 'CntPerPrd')
            self.CntPerPrd = fval_
            self.CntPerPrd_nsprefix_ = child_.prefix
            # validate type DecimalNumber
            self.validate_DecimalNumber(self.CntPerPrd)
# end class FrequencyPeriod1


class Garnishment4(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, Garnishment4)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if Garnishment4.subclass:
            return Garnishment4.subclass(*args_, **kwargs_)
        else:
            return Garnishment4(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='Garnishment4', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('Garnishment4')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'Garnishment4':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Garnishment4')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='Garnishment4', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Garnishment4'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='Garnishment4', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class GarnishmentType1(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='GarnishmentType1', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='GarnishmentType1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='GarnishmentType1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class GarnishmentType1Choice(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='GarnishmentType1Choice', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='GarnishmentType1Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='GarnishmentType1Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class GenericAccountIdentification1(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='GenericAccountIdentification1', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='GenericAccountIdentification1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='GenericAccountIdentification1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class GenericFinancialIdentification1(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='GenericFinancialIdentification1', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='GenericFinancialIdentification1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='GenericFinancialIdentification1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class GenericIdentification3(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Id=None, Issr=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, GenericIdentification3)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if GenericIdentification3.subclass:
            return GenericIdentification3.subclass(*args_, **kwargs_)
        else:
            return GenericIdentification3(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='GenericIdentification3', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('GenericIdentification3')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'GenericIdentification3':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='GenericIdentification3')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='GenericIdentification3', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='GenericIdentification3'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='GenericIdentification3', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Id':
            ...
            # validate type Max35Text
            self.validate_Max35Text(self.Issr)
# end class GenericIdentification3
...
class GenericIdentification30(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='GenericIdentification30', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='GenericIdentification30'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='GenericIdentification30', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class GenericOrganisationIdentification3(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Id=None, SchmeNm=None, Issr=None, gds_collector_=None, **kwargs_):
        ...
        self.ns_prefix_ = None
        self.Id = Id
        self.validate_Max256Text(self.Id)
        self.Id_nsprefix_ = None
        self.SchmeNm = SchmeNm
        self.SchmeNm_nsprefix_ = None
        self.Issr = Issr
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, GenericOrganisationIdentification3)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if GenericOrganisationIdentification3.subclass:
            return GenericOrganisationIdentification3.subclass(*args_, **kwargs_)
        else:
            return GenericOrganisationIdentification3(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='GenericOrganisationIdentification3', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('GenericOrganisationIdentification3')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'GenericOrganisationIdentification3':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='GenericOrganisationIdentification3')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='GenericOrganisationIdentification3', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='GenericOrganisationIdentification3'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='GenericOrganisationIdentification3', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Id':
            ...
            # validate type Max35Text
            self.validate_Max35Text(self.Issr)
# end class GenericOrganisationIdentification3


class GenericPersonIdentification2(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Id=None, SchmeNm=None, Issr=None, gds_collector_=None, **kwargs_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, GenericPersonIdentification2)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if GenericPersonIdentification2.subclass:
            return GenericPersonIdentification2.subclass(*args_, **kwargs_)
        else:
            return GenericPersonIdentification2(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='GenericPersonIdentification2', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('GenericPersonIdentification2')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'GenericPersonIdentification2':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='GenericPersonIdentification2')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='GenericPersonIdentification2', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='GenericPersonIdentification2'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='GenericPersonIdentification2', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Id':
            ...
            # validate type Max35Text
            self.validate_Max35Text(self.Issr)
# end class GenericPersonIdentification2


class GroupHeader113(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, GroupHeader113)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if GroupHeader113.subclass:
            return GroupHeader113.subclass(*args_, **kwargs_)
        else:
            return GroupHeader113(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='GroupHeader113', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('GroupHeader113')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'GroupHeader113':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='GroupHeader113')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='GroupHeader113', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='GroupHeader113'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='GroupHeader113', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'MsgId':
            ...
            obj_ = SettlementInstruction15.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.SttlmInf = obj_
            ...
            self.InstdAgt = obj_
            obj_.original_tagname_ = 'InstdAgt'
# end class GroupHeader113


class InstructionForCreditorAgent3(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Cd=None, InstrInf=None, gds_collector_=None, **kwargs_):
        ...
        self.ns_prefix_ = None
        self.Cd = Cd
        self.validate_ExternalCreditorAgentInstruction1Code(self.Cd)
        self.Cd_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, InstructionForCreditorAgent3)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if InstructionForCreditorAgent3.subclass:
            return InstructionForCreditorAgent3.subclass(*args_, **kwargs_)
        else:
            return InstructionForCreditorAgent3(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def set_InstrInf(self, InstrInf):
        self.InstrInf = InstrInf
    def validate_ExternalCreditorAgentInstruction1Code(self, value):
        result = True
        # Validate type ExternalCreditorAgentInstruction1Code, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if len(value) > 4:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on ExternalCreditorAgentInstruction1Code' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) < 1:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minLength restriction on ExternalCreditorAgentInstruction1Code' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_Max140Text(self, value):
        result = True
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='InstructionForCreditorAgent3', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('InstructionForCreditorAgent3')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'InstructionForCreditorAgent3':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='InstructionForCreditorAgent3')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='InstructionForCreditorAgent3', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='InstructionForCreditorAgent3'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='InstructionForCreditorAgent3', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Cd':
            ...
            self.Cd = value_
            self.Cd_nsprefix_ = child_.prefix
            # validate type ExternalCreditorAgentInstruction1Code
            self.validate_ExternalCreditorAgentInstruction1Code(self.Cd)
            ...
            # validate type Max140Text
            self.validate_Max140Text(self.InstrInf)
# end class InstructionForCreditorAgent3
...
class InstructionForNextAgent1(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='InstructionForNextAgent1', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='InstructionForNextAgent1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='InstructionForNextAgent1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class LocalInstrument2Choice(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='LocalInstrument2Choice', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='LocalInstrument2Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='LocalInstrument2Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class MandateClassification1Choice(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Cd=None, Prtry=None, gds_collector_=None, **kwargs_):
        ...
        self.ns_prefix_ = None
        self.Cd = Cd
        self.validate_MandateClassification1Code(self.Cd)
        self.Cd_nsprefix_ = None
        self.Prtry = Prtry
        self.validate_Max35Text(self.Prtry)
        self.Prtry_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, MandateClassification1Choice)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if MandateClassification1Choice.subclass:
            return MandateClassification1Choice.subclass(*args_, **kwargs_)
        else:
            return MandateClassification1Choice(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def set_Prtry(self, Prtry):
        self.Prtry = Prtry
    def validate_MandateClassification1Code(self, value):
        result = True
        # Validate type MandateClassification1Code, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
                return False
            value = value
            enumerations = ['FIXE', 'USGB', 'VARI']
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on MandateClassification1Code' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_Max35Text(self, value):
        result = True
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='MandateClassification1Choice', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('MandateClassification1Choice')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'MandateClassification1Choice':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='MandateClassification1Choice')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='MandateClassification1Choice', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='MandateClassification1Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='MandateClassification1Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Cd':
            ...
            self.Cd = value_
            self.Cd_nsprefix_ = child_.prefix
            # validate type MandateClassification1Code
            self.validate_MandateClassification1Code(self.Cd)
        elif nodeName_ == 'Prtry':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'Prtry')
            ...
            # validate type Max35Text
            self.validate_Max35Text(self.Prtry)
# end class MandateClassification1Choice


class MandateSetupReason1Choice(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, Cd=None, Prtry=None, gds_collector_=None, **kwargs_):
        ...
        self.ns_prefix_ = None
        self.Cd = Cd
        self.validate_ExternalMandateSetupReason1Code(self.Cd)
        self.Cd_nsprefix_ = None
        self.Prtry = Prtry
        self.validate_Max70Text(self.Prtry)
        self.Prtry_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, MandateSetupReason1Choice)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if MandateSetupReason1Choice.subclass:
            return MandateSetupReason1Choice.subclass(*args_, **kwargs_)
        else:
            return MandateSetupReason1Choice(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def set_Prtry(self, Prtry):
        self.Prtry = Prtry
    def validate_ExternalMandateSetupReason1Code(self, value):
        result = True
        # Validate type ExternalMandateSetupReason1Code, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if len(value) > 4:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd maxLength restriction on ExternalMandateSetupReason1Code' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) < 1:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd minLength restriction on ExternalMandateSetupReason1Code' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_Max70Text(self, value):
        result = True
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='MandateSetupReason1Choice', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('MandateSetupReason1Choice')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'MandateSetupReason1Choice':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='MandateSetupReason1Choice')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='MandateSetupReason1Choice', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='MandateSetupReason1Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='MandateSetupReason1Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Cd':
            ...
            self.Cd = value_
            self.Cd_nsprefix_ = child_.prefix
            # validate type ExternalMandateSetupReason1Code
            self.validate_ExternalMandateSetupReason1Code(self.Cd)
        elif nodeName_ == 'Prtry':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'Prtry')
            ...
            # validate type Max70Text
            self.validate_Max70Text(self.Prtry)
# end class MandateSetupReason1Choice


class MandateTypeInformation2(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, SvcLvl=None, LclInstrm=None, CtgyPurp=None, Clssfctn=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.Clssfctn = Clssfctn
        self.Clssfctn_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, MandateTypeInformation2)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if MandateTypeInformation2.subclass:
            return MandateTypeInformation2.subclass(*args_, **kwargs_)
        else:
            return MandateTypeInformation2(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def set_CtgyPurp(self, CtgyPurp):
        self.CtgyPurp = CtgyPurp
    def get_Clssfctn(self):
        return self.Clssfctn
    def set_Clssfctn(self, Clssfctn):
        self.Clssfctn = Clssfctn
    def has__content(self):
        if (
            self.SvcLvl is not None or
            self.LclInstrm is not None or
            self.CtgyPurp is not None or
            self.Clssfctn is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='MandateTypeInformation2', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('MandateTypeInformation2')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'MandateTypeInformation2':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='MandateTypeInformation2')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='MandateTypeInformation2', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='MandateTypeInformation2'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='MandateTypeInformation2', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.SvcLvl is not None:
            ...
            self.SvcLvl.export(outfile, level, namespaceprefix_, namespacedef_='', name_='SvcLvl', pretty_print=pretty_print)
        ...
        if self.Clssfctn is not None:
            namespaceprefix_ = self.Clssfctn_nsprefix_ + ':' if (UseCapturedNS_ and self.Clssfctn_nsprefix_) else ''
            self.Clssfctn.export(outfile, level, namespaceprefix_, namespacedef_='', name_='Clssfctn', pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'Clssfctn':
            obj_ = MandateClassification1Choice.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Clssfctn = obj_
            obj_.original_tagname_ = 'Clssfctn'
# end class MandateTypeInformation2


class NameAndAddress18(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, NameAndAddress18)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if NameAndAddress18.subclass:
            return NameAndAddress18.subclass(*args_, **kwargs_)
        else:
            return NameAndAddress18(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='NameAndAddress18', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('NameAndAddress18')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'NameAndAddress18':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='NameAndAddress18')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='NameAndAddress18', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='NameAndAddress18'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='NameAndAddress18', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
# end class NameAndAddress18


class OrganisationIdentification39(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, OrganisationIdentification39)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if OrganisationIdentification39.subclass:
            return OrganisationIdentification39.subclass(*args_, **kwargs_)
        else:
            return OrganisationIdentification39(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='OrganisationIdentification39', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('OrganisationIdentification39')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'OrganisationIdentification39':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='OrganisationIdentification39')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='OrganisationIdentification39', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='OrganisationIdentification39'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='OrganisationIdentification39', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'AnyBIC':
            ...
            obj_ = GenericOrganisationIdentification3.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Othr.append(obj_)
            obj_.original_tagname_ = 'Othr'
# end class OrganisationIdentification39
...
class OrganisationIdentificationSchemeName1Choice(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='OrganisationIdentificationSchemeName1Choice', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='OrganisationIdentificationSchemeName1Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='OrganisationIdentificationSchemeName1Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class OtherContact1(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='OtherContact1', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='OtherContact1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='OtherContact1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Party52Choice(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, Party52Choice)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if Party52Choice.subclass:
            return Party52Choice.subclass(*args_, **kwargs_)
        else:
            return Party52Choice(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='Party52Choice', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('Party52Choice')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'Party52Choice':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Party52Choice')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='Party52Choice', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Party52Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='Party52Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'OrgId':
            obj_ = OrganisationIdentification39.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.OrgId = obj_
            obj_.original_tagname_ = 'OrgId'
        elif nodeName_ == 'PrvtId':
            obj_ = PersonIdentification18.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.PrvtId = obj_
            obj_.original_tagname_ = 'PrvtId'
# end class Party52Choice


class PartyIdentification272(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, PartyIdentification272)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if PartyIdentification272.subclass:
            return PartyIdentification272.subclass(*args_, **kwargs_)
        else:
            return PartyIdentification272(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='PartyIdentification272', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('PartyIdentification272')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'PartyIdentification272':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PartyIdentification272')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PartyIdentification272', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PartyIdentification272'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='PartyIdentification272', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Nm':
            ...
            obj_ = Party52Choice.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Id = obj_
            obj_.original_tagname_ = 'Id'
            ...
            obj_ = Contact13.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.CtctDtls = obj_
            obj_.original_tagname_ = 'CtctDtls'
# end class PartyIdentification272


class PaymentIdentification13(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, PaymentIdentification13)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if PaymentIdentification13.subclass:
            return PaymentIdentification13.subclass(*args_, **kwargs_)
        else:
            return PaymentIdentification13(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='PaymentIdentification13', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('PaymentIdentification13')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'PaymentIdentification13':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PaymentIdentification13')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PaymentIdentification13', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PaymentIdentification13'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='PaymentIdentification13', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'InstrId':
            ...
            # validate type Max35Text
            self.validate_Max35Text(self.ClrSysRef)
# end class PaymentIdentification13
...
class PaymentTypeInformation28(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='PaymentTypeInformation28', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PaymentTypeInformation28'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='PaymentTypeInformation28', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class PersonIdentification18(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, PersonIdentification18)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if PersonIdentification18.subclass:
            return PersonIdentification18.subclass(*args_, **kwargs_)
        else:
            return PersonIdentification18(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='PersonIdentification18', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('PersonIdentification18')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'PersonIdentification18':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PersonIdentification18')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PersonIdentification18', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PersonIdentification18'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='PersonIdentification18', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'DtAndPlcOfBirth':
            ...
            obj_ = GenericPersonIdentification2.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Othr.append(obj_)
            obj_.original_tagname_ = 'Othr'
# end class PersonIdentification18
...
class PersonIdentificationSchemeName1Choice(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='PersonIdentificationSchemeName1Choice', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PersonIdentificationSchemeName1Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='PersonIdentificationSchemeName1Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class PostalAddress27(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, AdrTp=None, CareOf=None, Dept=None, SubDept=None, StrtNm=None, BldgNb=None, BldgNm=None, Flr=None, UnitNb=None, PstBx=None, Room=None, PstCd=None, TwnNm=None, TwnLctnNm=None, DstrctNm=None, CtrySubDvsn=None, Ctry=None, AdrLine=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.CareOf = CareOf
        self.validate_Max140Text(self.CareOf)
        ...
        self.TwnNm = TwnNm
        self.validate_Max140Text(self.TwnNm)
        self.TwnNm_nsprefix_ = None
        self.TwnLctnNm = TwnLctnNm
        self.validate_Max140Text(self.TwnLctnNm)
        self.TwnLctnNm_nsprefix_ = None
        self.DstrctNm = DstrctNm
        self.validate_Max140Text(self.DstrctNm)
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, PostalAddress27)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if PostalAddress27.subclass:
            return PostalAddress27.subclass(*args_, **kwargs_)
        else:
            return PostalAddress27(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='PostalAddress27', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('PostalAddress27')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'PostalAddress27':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PostalAddress27')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PostalAddress27', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PostalAddress27'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='PostalAddress27', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.UnitNb is not None:
            namespaceprefix_ = self.UnitNb_nsprefix_ + ':' if (UseCapturedNS_ and self.UnitNb_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sUnitNb>%s</%sUnitNb>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.UnitNb), input_name='UnitNb')), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'AdrTp':
            ...
            # validate type Max70Text
            self.validate_Max70Text(self.Flr)
        elif nodeName_ == 'UnitNb':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'UnitNb')
            value_ = self.gds_validate_string(value_, node, 'UnitNb')
            self.UnitNb = value_
            self.UnitNb_nsprefix_ = child_.prefix
            # validate type Max16Text
            self.validate_Max16Text(self.UnitNb)
...
class ProxyAccountIdentification1(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='ProxyAccountIdentification1', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ProxyAccountIdentification1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='ProxyAccountIdentification1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ProxyAccountType1Choice(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='ProxyAccountType1Choice', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ProxyAccountType1Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='ProxyAccountType1Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class Purpose2Choice(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='Purpose2Choice', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='Purpose2Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='Purpose2Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class ReferredDocumentInformation8(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ReferredDocumentInformation8)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ReferredDocumentInformation8.subclass:
            return ReferredDocumentInformation8.subclass(*args_, **kwargs_)
        else:
            return ReferredDocumentInformation8(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='ReferredDocumentInformation8', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ReferredDocumentInformation8')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'ReferredDocumentInformation8':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='ReferredDocumentInformation8')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='ReferredDocumentInformation8', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ReferredDocumentInformation8'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='ReferredDocumentInformation8', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.RltdDt is not None:
            namespaceprefix_ = self.RltdDt_nsprefix_ + ':' if (UseCapturedNS_ and self.RltdDt_nsprefix_) else ''
            self.RltdDt.export(outfile, level, namespaceprefix_, namespacedef_='', name_='RltdDt', pretty_print=pretty_print)
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Tp':
            obj_ = DocumentType1.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Tp = obj_
            obj_.original_tagname_ = 'Tp'
        elif nodeName_ == 'Nb':
            ...
            obj_ = DateAndType1.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.RltdDt = obj_
            obj_.original_tagname_ = 'RltdDt'
        elif nodeName_ == 'LineDtls':
            obj_ = DocumentLineInformation2.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.LineDtls.append(obj_)
            obj_.original_tagname_ = 'LineDtls'
# end class ReferredDocumentInformation8
...
class RegulatoryAuthority2(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='RegulatoryAuthority2', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='RegulatoryAuthority2'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='RegulatoryAuthority2', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class RegulatoryReporting3(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='RegulatoryReporting3', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='RegulatoryReporting3'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='RegulatoryReporting3', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class RemittanceAmount4(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, RmtAmtAndTp=None, AdjstmntAmtAndRsn=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        if RmtAmtAndTp is None:
            self.RmtAmtAndTp = []
        else:
            self.RmtAmtAndTp = RmtAmtAndTp
        self.RmtAmtAndTp_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, RemittanceAmount4)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if RemittanceAmount4.subclass:
            return RemittanceAmount4.subclass(*args_, **kwargs_)
        else:
            return RemittanceAmount4(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
        self.ns_prefix_ = ns_prefix
    def get_RmtAmtAndTp(self):
        return self.RmtAmtAndTp
    def set_RmtAmtAndTp(self, RmtAmtAndTp):
        self.RmtAmtAndTp = RmtAmtAndTp
    def add_RmtAmtAndTp(self, value):
        self.RmtAmtAndTp.append(value)
    def insert_RmtAmtAndTp_at(self, index, value):
        self.RmtAmtAndTp.insert(index, value)
    def replace_RmtAmtAndTp_at(self, index, value):
        self.RmtAmtAndTp[index] = value
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='RemittanceAmount4', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('RemittanceAmount4')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'RemittanceAmount4':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='RemittanceAmount4')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='RemittanceAmount4', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='RemittanceAmount4'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='RemittanceAmount4', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for RmtAmtAndTp_ in self.RmtAmtAndTp:
            namespaceprefix_ = self.RmtAmtAndTp_nsprefix_ + ':' if (UseCapturedNS_ and self.RmtAmtAndTp_nsprefix_) else ''
            RmtAmtAndTp_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='RmtAmtAndTp', pretty_print=pretty_print)
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        pass
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'RmtAmtAndTp':
            obj_ = DocumentAmount1.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.RmtAmtAndTp.append(obj_)
            obj_.original_tagname_ = 'RmtAmtAndTp'
...
# end class RemittanceAmount4


class RemittanceInformation22(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, RemittanceInformation22)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if RemittanceInformation22.subclass:
            return RemittanceInformation22.subclass(*args_, **kwargs_)
        else:
            return RemittanceInformation22(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='RemittanceInformation22', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('RemittanceInformation22')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'RemittanceInformation22':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='RemittanceInformation22')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='RemittanceInformation22', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='RemittanceInformation22'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='RemittanceInformation22', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Ustrd':
            ...
            obj_ = StructuredRemittanceInformation18.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Strd.append(obj_)
            obj_.original_tagname_ = 'Strd'
# end class RemittanceInformation22


class RemittanceLocation8(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, RemittanceLocation8)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if RemittanceLocation8.subclass:
            return RemittanceLocation8.subclass(*args_, **kwargs_)
        else:
            return RemittanceLocation8(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='RemittanceLocation8', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('RemittanceLocation8')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'RemittanceLocation8':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='RemittanceLocation8')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='RemittanceLocation8', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='RemittanceLocation8'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='RemittanceLocation8', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'RmtId':
            ...
            obj_ = RemittanceLocationData2.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.RmtLctnDtls.append(obj_)
            obj_.original_tagname_ = 'RmtLctnDtls'
# end class RemittanceLocation8


class RemittanceLocationData2(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, RemittanceLocationData2)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if RemittanceLocationData2.subclass:
            return RemittanceLocationData2.subclass(*args_, **kwargs_)
        else:
            return RemittanceLocationData2(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='RemittanceLocationData2', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('RemittanceLocationData2')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'RemittanceLocationData2':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='RemittanceLocationData2')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='RemittanceLocationData2', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='RemittanceLocationData2'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='RemittanceLocationData2', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Mtd':
            ...
            obj_ = NameAndAddress18.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.PstlAdr = obj_
            obj_.original_tagname_ = 'PstlAdr'
# end class RemittanceLocationData2
...
class ServiceLevel8Choice(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='ServiceLevel8Choice', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='ServiceLevel8Choice'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='ServiceLevel8Choice', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class SettlementDateTimeIndication1(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='SettlementDateTimeIndication1', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='SettlementDateTimeIndication1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='SettlementDateTimeIndication1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class SettlementInstruction15(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, SettlementInstruction15)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if SettlementInstruction15.subclass:
            return SettlementInstruction15.subclass(*args_, **kwargs_)
        else:
            return SettlementInstruction15(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='SettlementInstruction15', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('SettlementInstruction15')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'SettlementInstruction15':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='SettlementInstruction15')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='SettlementInstruction15', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='SettlementInstruction15'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='SettlementInstruction15', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
# end class SettlementInstruction15
...
class SettlementTimeRequest2(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='SettlementTimeRequest2', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='SettlementTimeRequest2'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='SettlementTimeRequest2', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class StructuredRegulatoryReporting3(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='StructuredRegulatoryReporting3', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='StructuredRegulatoryReporting3'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='StructuredRegulatoryReporting3', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class StructuredRemittanceInformation18(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, StructuredRemittanceInformation18)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if StructuredRemittanceInformation18.subclass:
            return StructuredRemittanceInformation18.subclass(*args_, **kwargs_)
        else:
            return StructuredRemittanceInformation18(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='StructuredRemittanceInformation18', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('StructuredRemittanceInformation18')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'StructuredRemittanceInformation18':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='StructuredRemittanceInformation18')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='StructuredRemittanceInformation18', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='StructuredRemittanceInformation18'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='StructuredRemittanceInformation18', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'RfrdDocInf':
            obj_ = ReferredDocumentInformation8.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            ...
            obj_ = CreditorReferenceInformation3.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            ...
            obj_ = Garnishment4.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
...
# end class StructuredRemittanceInformation18
...
class SupplementaryData1(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='SupplementaryData1', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='SupplementaryData1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='SupplementaryData1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class SupplementaryDataEnvelope1(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='SupplementaryDataEnvelope1', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='SupplementaryDataEnvelope1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='SupplementaryDataEnvelope1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TaxAmount3(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TaxAmount3)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TaxAmount3.subclass:
            return TaxAmount3.subclass(*args_, **kwargs_)
        else:
            return TaxAmount3(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='TaxAmount3', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('TaxAmount3')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'TaxAmount3':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TaxAmount3')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TaxAmount3', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TaxAmount3'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='TaxAmount3', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Rate' and child_.text:
            ...
            obj_ = TaxRecordDetails3.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Dtls.append(obj_)
            obj_.original_tagname_ = 'Dtls'
# end class TaxAmount3
...
class TaxAuthorisation1(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='TaxAuthorisation1', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TaxAuthorisation1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='TaxAuthorisation1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TaxData1(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TaxData1)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TaxData1.subclass:
            return TaxData1.subclass(*args_, **kwargs_)
        else:
            return TaxData1(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='TaxData1', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('TaxData1')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'TaxData1':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TaxData1')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TaxData1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TaxData1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='TaxData1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Cdtr':
            ...
            obj_ = TaxRecord3.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
...
class TaxParty1(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='TaxParty1', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TaxParty1'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='TaxParty1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TaxParty2(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='TaxParty2', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TaxParty2'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='TaxParty2', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TaxPeriod3(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TaxPeriod3)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TaxPeriod3.subclass:
            return TaxPeriod3.subclass(*args_, **kwargs_)
        else:
            return TaxPeriod3(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def set_FrToDt(self, FrToDt):
        self.FrToDt = FrToDt
    def validate_ISOYear(self, value):
        result = True
        # Validate type ISOYear, a restriction on xs:gYear.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            pass
        return result
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='TaxPeriod3', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('TaxPeriod3')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'TaxPeriod3':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TaxPeriod3')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TaxPeriod3', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TaxPeriod3'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='TaxPeriod3', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.Yr is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sYr>%s</%sYr>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.Yr), input_name='Yr')), namespaceprefix_ , eol_))
        if self.Tp is not None:
            namespaceprefix_ = self.Tp_nsprefix_ + ':' if (UseCapturedNS_ and self.Tp_nsprefix_) else ''
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sTp>%s</%sTp>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.Tp), input_name='Tp')), namespaceprefix_ , eol_))
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Yr':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'Yr')
            value_ = self.gds_validate_string(value_, node, 'Yr')
            self.Yr = value_
            self.Yr_nsprefix_ = child_.prefix
            # validate type ISOYear
            self.validate_ISOYear(self.Yr)
        elif nodeName_ == 'Tp':
            value_ = child_.text
            value_ = self.gds_parse_string(value_, node, 'Tp')
...
# end class TaxPeriod3


class TaxRecord3(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TaxRecord3)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TaxRecord3.subclass:
            return TaxRecord3.subclass(*args_, **kwargs_)
        else:
            return TaxRecord3(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='TaxRecord3', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('TaxRecord3')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'TaxRecord3':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TaxRecord3')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TaxRecord3', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TaxRecord3'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='TaxRecord3', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'Tp':
            ...
            obj_ = TaxPeriod3.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.Prd = obj_
            obj_.original_tagname_ = 'Prd'
        elif nodeName_ == 'TaxAmt':
            obj_ = TaxAmount3.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.TaxAmt = obj_
            ...
            # validate type Max140Text
            self.validate_Max140Text(self.AddtlInf)
# end class TaxRecord3


class TaxRecordDetails3(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, TaxRecordDetails3)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if TaxRecordDetails3.subclass:
            return TaxRecordDetails3.subclass(*args_, **kwargs_)
        else:
            return TaxRecordDetails3(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='TaxRecordDetails3', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('TaxRecordDetails3')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'TaxRecordDetails3':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='TaxRecordDetails3')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='TaxRecordDetails3', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='TaxRecordDetails3'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_=' xmlns:None="urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12" ', name_='TaxRecordDetails3', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from pacs_008_001_12 import *\n\n')
        sys.stdout.write('import pacs_008_001_12 as model_\n\n')
...
NamespaceToDefMappings_ = {'urn:iso:std:iso:20022:tech:xsd:pacs.008.001.12': [('ActiveCurrencyAndAmount_SimpleType',
                                                     'xsd/pacs.008.001.12.xsd',
                                                     'ST'),
                                                    ('ActiveCurrencyCode',
                                                     'xsd/pacs.008.001.12.xsd',
